...
server      = os.environ['AIW_server']
database    = os.environ['AIW_database']
username    = os.environ['AIW_username']
password    = os.environ['AIW_password']
ODBC_driver = os.environ['AIW_ODBC_driver']
